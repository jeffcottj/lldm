/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc types/wrangler.d.ts` (hash: 441f3cc6c52d3044f5264dacd39dc065)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "https://relay.invalid";
	ROOMS: DurableObjectNamespace<import("../apps/relay/src/index").DurableRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../apps/relay/src/index");
		durableNamespaces: "DurableRoom";
	}
